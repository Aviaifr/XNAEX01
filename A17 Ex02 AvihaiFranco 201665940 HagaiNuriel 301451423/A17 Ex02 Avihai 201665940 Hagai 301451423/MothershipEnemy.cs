...
namespace Space_Invaders
{
    public class MothershipEnemy : Enemy
    {
        ...
        {
            int randomToAppear = s_RandomGen.Next(0, 800);
        ...
        public override bool CanCollideWith(ICollidable i_Source)
        {
            ...
            if (i_Source is SpaceBullet && isCollidable)
            {
        ...
        {
            m_Sounds.Add("hit", Game.Content.Load<SoundEffect>(@"C:/Temp/XNA_Assets/Ex03/Sounds/MotherShipKill"));
        }
    }
}
