...
namespace A17_Ex01_Avihai_201665940
{
    ...
    {
        public static readonly string sr_BackgroundTextureString = @"Backgrounds/BG_Space01_1024x768";
        public static readonly string sr_UserShipTextureString = "Spaceship/Ship01_32x32";
        public static readonly string sr_Enemy1TextureString = "Enemies/Enemy0101_32x32";
        public static readonly string sr_Enemy2TextureString = "Enemies/Enemy0201_32x32";
        public static readonly string sr_Enemy3TextureString = "Enemies/Enemy0301_32x32";
        public static readonly string sr_MothershipTextureString = "Enemies/MotherShip_32x120";
        public static readonly string sr_BulletTextureString = "Shots/Bullet";
        ...
        public static string GetEnemySpriteByRow(int i_Row)
        {
            ...
            {
                case 0:
                    spriteLoc = sr_Enemy1TextureString;
                    break;
                case 1:
                case 2:
                    spriteLoc = sr_Enemy2TextureString;
                    break;
                case 3:
                case 4:
                    spriteLoc = sr_Enemy3TextureString;
                    break;
            }
